    ...
    <div>
      <div className="panel">
        ...
        <div className="btn-row" style={{ alignItems: "stretch" }}>
          <FighterPanel label="あなた" player={me} isSelf />
          <FighterPanel label="相手" player={opponent} isSelf={false} />
        </div>
      </div>
              ...
              <div className="action-grid">
                ...
                {me.fighter!.hasSpecial && (
                  <button
                    ...
                    disabled={me.fighter!.specialCooldown > 0}
                ...
                {me.fighter!.hasGamble && (
                  <button
                    className="action-btn"
                    disabled={me.fighter!.gambleCooldown > 0}
...
function FighterPanel({ label, player, isSelf }: { label: string; player: PlayerDTO; isSelf: boolean }) {
      ...
      {f ? (
        <>
          ...
          <div style={{ margin: "0.5rem 0 0.25rem" }}>
            <FighterVitals hp={f.hp} maxHp={f.maxHp} />
          </div>
          <div style={{ fontSize: "0.85rem" }}>
            HP {f.hp}/{f.maxHp} ・ ATK {f.atk} ・ DEF {f.def} ・ SPD {f.spd}
          </div>
